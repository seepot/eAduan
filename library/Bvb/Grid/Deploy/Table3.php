		...
		*/
        foreach ( $grids as $key => $value )
        {
			...
			foreach ( $value as $final )
            {
				...
				{
					if($final['field'] == $this->_arrLegend['field']) //detect field untuk legend
					{
			...
			//$_icon = $this->_arrIcon;
			$_icon = $newIcon;
            $grid .= $this->temp ['table']->loopEnd ( $_view, $_edit, $_delete, $_other, $_icon, $id[$key], $this->_iconController, $_ctrlValue );
