...
class Spt_Form_PPP_Pengkelasan_Facilities extends Zend_Dojo_Form
{
    public $rowfacilities;	
	public $categoryTypeId;
	  public function facilities()
	{
		return $this->rowfacilities;
	}  
    ...
    {
        $this->setAction(SYSTEM_URL.'/ppp/classification/applynew?currtab=facilities');
		$this->setMethod('post');
