...
class My_Template_Table_Work extends Bvb_Grid_Template_Table_Table
{
    ...
    function globalStart()
    {
        ...
        return "<table class=\"table hovered\" width=\"100%\"  align=\"center\" cellspacing=\"1\" >";
    }
    ...
    {
        return "<thead><tr><th width=\"10%\">".$this->translate()->_('Bil')."&nbsp;&nbsp;&nbsp;<a href='#' onClick=\"filters()\"><img title='Carian' src=\"".IMAGES_PATH."spt/narrow_by_li_by.gif\"></a></th>";
    ...
    function loopEnd ($view, $edit, $delete, $other, $arr_icon, $id, $field, $values,$idname)
    {
		...
		$str_loop .= "$viewIcon$editIcon$otherIcon$deleteIcon</td></tr>";
	...
	function filtersStart ()
    {
		...
		return "<tr style=\"display:none;\" id=\"filter\"><th>&nbsp;</th>";
    }
	...
	function pagination()
    {
		...
		return "</tbody><tfoot><tr><td class=\"barra_tabela\" colspan=\"".($this->colSpan+2)."\"><div style=\"padding:2px;\">
