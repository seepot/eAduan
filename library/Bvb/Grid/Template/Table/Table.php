...
class Bvb_Grid_Template_Table_Table
{
    ...
    function globalStart ()
    {
        ...
        <table  width=\"100%\" id=\"rounded-corner\" class=\"borders\" align=\"center\" cellspacing=\"0\" celpadding=\"0\">";
    }
    ...
    function extra()
    {
        return "<tr><td  colspan=\"".($this->colSpan+2)."\" class=\"querySupport\"><div style=\"text-align:right;\">{{value}}</div></td></tr>";
    }
    ...
    function loopEnd ($a,$b,$c,$d,$e,$f,$g,$h,$i)
    {
        return "</tr>";
    }
